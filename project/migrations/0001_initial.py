# Generated by Django 4.0.5 on 2022-06-24 20:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Company',
            fields=[
                ('cat_id', models.SmallIntegerField(primary_key=True, serialize=False, unique=True, verbose_name='ИНН')),
                ('name', models.TextField(verbose_name='Название компании')),
                ('phone', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None, verbose_name='Контактный номер')),
